...
void main() {
  group('To-Date Target Calculations', () {
    ...
    test('On Jan 2, January target-to-date should be 8h (Jan 1 is holiday, Jan 2 is workday)', () {
      final weeklyTargetMinutes = 40 * 60; // 2400
    ...
    test('Year target-to-date equals month target-to-date on Jan 2 (early year)', () {
      final weeklyTargetMinutes = 40 * 60; // 2400
      ...
      expect(yearTarget, equals(monthTarget),
          reason: 'Year target-to-date should equal month target-to-date on Jan 2');
    });
