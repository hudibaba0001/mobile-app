...
void main() {
  group('Balance Calculations with Holidays and Absences', () {
    ...
    test('Weekday holiday: scheduled=0', () {
      ...
      expect(scheduled, 0,
          reason: 'Holiday on weekday should have scheduled=0');
    });
    ...
    test('Paid sick day with no work: credit=scheduled → variance=0', () {
      ...
      expect(variance, 0,
          reason: 'Full paid sick day should result in variance=0');
    });
    ...
    test('Partial paid vacation (240 min) on normal day scheduled=480', () {
      ...
      expect(credit, 240);
      expect(variance, -240,
          reason: 'Partial vacation should result in -240 min variance');
    });
