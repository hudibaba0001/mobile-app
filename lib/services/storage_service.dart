...
class StorageService {
  ...
  /// List all files in a user's profile directory
  /// 
  /// [userId] - The unique identifier for the user
  /// 
  ...
  Future<List<Reference>> listUserFiles(String userId) async {
    try {
      // Get reference to user's directory
      final ref = _storage.ref('profiles/$userId');
      ...
      throw Exception('Failed to list user files: ${e.message}');
    } catch (e) {
      throw Exception('Unexpected error listing files: $e');
    }
  }
